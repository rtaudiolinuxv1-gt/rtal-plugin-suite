...
APP_ID="rtal-live-forever"
PACKAGE_ROOT="$RELEASE_DIR/rtal-live-forever-1.0.0-linux"
...
(
    cd "$RELEASE_DIR"
    tar -czf "rtal-live-forever-1.0.0-linux.tar.gz" "rtal-live-forever-1.0.0-linux"
)

echo "[$APP_ID] Packaged release at $RELEASE_DIR/rtal-live-forever-1.0.0-linux.tar.gz"

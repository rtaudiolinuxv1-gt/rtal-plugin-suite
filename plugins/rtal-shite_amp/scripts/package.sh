...
PACKAGE_ROOT="$RELEASE_DIR/rtal-shite_amp-1.0.0-linux"
...
(
    cd "$RELEASE_DIR"
    tar -czf "rtal-shite_amp-1.0.0-linux.tar.gz" "rtal-shite_amp-1.0.0-linux"
)

echo "[$APP_ID] Packaged release at $RELEASE_DIR/rtal-shite_amp-1.0.0-linux.tar.gz"

...
APP_ID="rtal-dreams-of-electric-cabinets"
PACKAGE_ROOT="$RELEASE_DIR/rtal-dreams-of-electric-cabinets-1.0.0-linux"
...
(
    cd "$RELEASE_DIR"
    tar -czf "rtal-dreams-of-electric-cabinets-1.0.0-linux.tar.gz" "rtal-dreams-of-electric-cabinets-1.0.0-linux"
)

echo "[$APP_ID] Packaged release at $RELEASE_DIR/rtal-dreams-of-electric-cabinets-1.0.0-linux.tar.gz"

...
APP_ID="rtal-crystal-pluck"
PACKAGE_ROOT="$RELEASE_DIR/rtal-crystal-pluck-1.0.0-linux"
...
(
    cd "$RELEASE_DIR"
    tar -czf "rtal-crystal-pluck-1.0.0-linux.tar.gz" "rtal-crystal-pluck-1.0.0-linux"
)

echo "[$APP_ID] Packaged release at $RELEASE_DIR/rtal-crystal-pluck-1.0.0-linux.tar.gz"

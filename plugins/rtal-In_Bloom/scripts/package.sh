...
APP_ID="rtal-In_Bloom"
PACKAGE_ROOT="$RELEASE_DIR/rtal-In_Bloom-1.0.0-linux"
...
(
    cd "$RELEASE_DIR"
    tar -czf "rtal-In_Bloom-1.0.0-linux.tar.gz" "rtal-In_Bloom-1.0.0-linux"
)

echo "[$APP_ID] Packaged release at $RELEASE_DIR/rtal-In_Bloom-1.0.0-linux.tar.gz"

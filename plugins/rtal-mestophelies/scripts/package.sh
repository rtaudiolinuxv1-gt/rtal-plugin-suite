...
APP_ID="rtal-mestophelies"
PACKAGE_ROOT="$RELEASE_DIR/rtal-mestophelies-1.0.0-linux"
...
(
    cd "$RELEASE_DIR"
    tar -czf "rtal-mestophelies-1.0.0-linux.tar.gz" "rtal-mestophelies-1.0.0-linux"
)

echo "[$APP_ID] Packaged release at $RELEASE_DIR/rtal-mestophelies-1.0.0-linux.tar.gz"

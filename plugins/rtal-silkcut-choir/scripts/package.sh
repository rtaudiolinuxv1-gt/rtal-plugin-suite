...
APP_ID="rtal-silkcut-choir"
PACKAGE_ROOT="$RELEASE_DIR/rtal-silkcut-choir-1.0.0-linux"
...
(
    cd "$RELEASE_DIR"
    tar -czf "rtal-silkcut-choir-1.0.0-linux.tar.gz" "rtal-silkcut-choir-1.0.0-linux"
)

echo "[$APP_ID] Packaged release at $RELEASE_DIR/rtal-silkcut-choir-1.0.0-linux.tar.gz"

...
APP_ID="rtal-guitar-shadow"
PACKAGE_ROOT="$RELEASE_DIR/rtal-guitar-shadow-1.0.0-linux"
...
(
    cd "$RELEASE_DIR"
    tar -czf "rtal-guitar-shadow-1.0.0-linux.tar.gz" "rtal-guitar-shadow-1.0.0-linux"
)

echo "[$APP_ID] Packaged release at $RELEASE_DIR/rtal-guitar-shadow-1.0.0-linux.tar.gz"
